! function(t, e) {
    ...
    var n = {
        ...
        hsv2hsl: function(t) {
            var e, i, o = t[0],
                n = t[1] / 100,
                s = t[2] / 100;
            return e = n * s, [o, 100 * (e = (e /= (i = (2 - n) * s) <= 1 ? i : 2 - i) || 0), 100 * (i /= 2)]
        },
        hsv2hwb: function(t) {
            return i(u(t))
        },
    ...
    function e(t) {
        var e, i, o = t[0],
            ...
            r = Math.max(o, n, s),
            l = r - a;
        return i = 0 == r ? 0 : l / r * 1e3 / 10, r == a ? e = 0 : o == r ? e = (n - s) / l : n == r ? e = 2 + (s - o) / l : s == r && (e = 4 + (o - n) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), [e, i, r / 255 * 1e3 / 10]
    }
    ...
    function y(t) {
        var e, i, o, n, s = t[0],
            a = t[1],
            r = t[2];
        return n = s <= 8 ? (i = 100 * s / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((s + 16) / 116, 3), Math.pow(i / 100, 1 / 3)), [e = e / 95.047 <= .008856 ? e = 95.047 * (a / 500 + n - 16 / 116) / 7.787 : 95.047 * Math.pow(a / 500 + n, 3), i, o = o / 108.883 <= .008859 ? o = 108.883 * (n - r / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(n - r / 200, 3)]
    }
    ...
    V.prototype = {
        ...
        if (n.alpha = Math.max(0, Math.min(1, void 0 === r ? n.alpha : r)), "alpha" === t) return !1;
        for (i = 0; i < t.length; i++) o = Math.max(0, Math.min(a[t][i], n[t][i])), n[t][i] = Math.round(o);
        for (var c in s) c !== t && (n[c] = L[t][c](n[t]));
        return !0
        ...
        nt = {
            ...
            roundedRect: function(t, e, i, o, n, s) {
                if (s) {
                    var a = Math.min(s, n / 2, o / 2),
                        ...
                        c = e + o - a,
                        d = i + n - a;
                    t.moveTo(e, l), r < c && l < d ? (t.arc(r, l, a, -K, -et), t.arc(c, l, a, -et, 0), t.arc(c, d, a, 0, et), t.arc(r, d, a, et, K)) : r < c ? (t.moveTo(r, i), t.arc(c, l, a, -et, et), t.arc(r, l, a, et, K + et)) : l < d ? (t.arc(r, l, a, -K, 0), t.arc(r, d, a, 0, K)) : t.arc(r, l, a, -K, K), t.closePath(), t.moveTo(e, i)
                } else t.rect(e, i, o, n)
            },
            ...
            lineTo: function(t, e, i, o) {
                ...
                if (n) {
                    if ("middle" === n) {
                        var s = (e.x + i.x) / 2;
                        t.lineTo(s, o ? i.y : e.y), t.lineTo(s, o ? e.y : i.y)
                    } else "after" === n && !o || "after" !== n && o ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y);
                    t.lineTo(i.x, i.y)
                } else i.tension ? t.bezierCurveTo(o ? e.controlPointPreviousX : e.controlPointNextX, o ? e.controlPointPreviousY : e.controlPointNextY, o ? i.controlPointNextX : i.controlPointPreviousX, o ? i.controlPointNextY : i.controlPointPreviousY, i.x, i.y) : t.lineTo(i.x, i.y)
            }
        },
        st = nt;
    ...
    var rt = at,
        ...
        ct = {
            ...
            resolve: function(t, e, i) {
                ...
                for (o = 0, n = t.length; o < n; ++o)
                    if (void 0 !== (s = t[o]) && (void 0 !== e && "function" == typeof s && (s = s(e)), void 0 !== i && Q.isArray(s) && (s = s[i]), void 0 !== s)) return s
            }
        },
        dt = Q,
        ht = G,
        ut = st,
        pt = ct;
    dt.easing = ht, dt.canvas = ut, dt.options = pt;
        ...
        transition: function(t) {
            ...
            return i && 1 !== t ? (n = n || (e._view = {}), function(t, e, i, o) {
                ...
                for (n = 0, s = p.length; n < s; ++n)
                    if (c = i[a = p[n]], e.hasOwnProperty(a) || (e[a] = c), (r = e[a]) !== c && "_" !== a[0]) {
                        if (t.hasOwnProperty(a) || (t[a] = r), (d = typeof c) == typeof(l = t[a]))
                            if ("string" == d) {
    ...
    function _t(e, t) {
        ...
        if (i) {
            var o = i.listeners,
                n = o.indexOf(t); - 1 !== n && o.splice(n, 1), 0 < o.length || (xt.forEach(function(t) {
                delete e[t]
            }), delete e._chartjs)
        }
    }
    ...
    dt.extend(wt.prototype, {
        ...
        buildOrUpdateElements: function() {
            var n, t, e = this,
                i = e.getDataset(),
                o = i.data || (i.data = []);
            e._data !== o && (e._data && _t(e._data, e), o && Object.isExtensible(o) && (t = e, (n = o)._chartjs ? n._chartjs.listeners.push(t) : (Object.defineProperty(n, "_chartjs", {
                configurable: !0,
                enumerable: !1,
                value: {
                    listeners: [t]
        ...
        setHoverStyle: function(t) {
            ...
            }, n.backgroundColor = yt([o.hoverBackgroundColor, e.hoverBackgroundColor, s(n.backgroundColor)], void 0, i), n.borderColor = yt([o.hoverBorderColor, e.hoverBorderColor, s(n.borderColor)], void 0, i), n.borderWidth = yt([o.hoverBorderWidth, e.hoverBorderWidth, n.borderWidth], void 0, i)
        },
    ...
    var At = gt.extend({
            ...
            draw: function(t) {
                var e = this._view,
                    ...
                    l = rt.global,
                    c = l.defaultColor;
                e.skip || void 0 !== t && !dt.canvas._isPointInArea(e, t) || (i.strokeStyle = e.borderColor || c, i.lineWidth = $t(e.borderWidth, l.elements.point.borderWidth), i.fillStyle = e.backgroundColor || c, dt.canvas.drawPoint(i, o, s, a, r, n))
            }
        }),
    ...
    function Dt(t) {
        var e, i, o, n, s;
        return n = Ft(t) ? (s = t.width / 2, e = t.x - s, i = t.x + s, o = Math.min(t.y, t.base), Math.max(t.y, t.base)) : (s = t.height / 2, e = Math.min(t.x, t.base), i = Math.max(t.x, t.base), o = t.y - s, t.y + s), {
            left: e,
            top: o,
            right: i,
            bottom: n
    ...
    var Et = gt.extend({
            draw: function() {
                var t, e, i, o, n, s, a, r, l, c, d, h, u, p, f, g, m = this._chart.ctx,
                    v = this._view,
                    b = (u = Dt(t = v), p = u.right - u.left, f = u.bottom - u.top, i = p / 2, o = f / 2, d = (e = t).borderWidth, l = e.borderSkipped, c = {}, l && (e.horizontal ? e.base > e.x && (l = Ot(l, "left", "right")) : e.base < e.y && (l = Ot(l, "bottom", "top")), c[l] = !0), h = c, dt.isObject(d) ? (n = +d.top || 0, s = +d.right || 0, a = +d.bottom || 0, r = +d.left || 0) : n = s = a = r = +d || 0, g = {
        ...
        jt = At,
        Bt = Et;
    Rt.Arc = Wt, Rt.Line = Ht, Rt.Point = jt, Rt.Rectangle = Bt;
    ...
    var qt = kt.extend({
            ...
            _getStacks: function(t) {
                var e, i, o = this.chart,
                    ...
                    a = [];
                for (e = 0; e < s; ++e)(i = o.getDatasetMeta(e)).bar && o.isDatasetVisible(e) && (!1 === n || !0 === n && -1 === a.indexOf(i.stack) || void 0 === n && (void 0 === i.stack || -1 === a.indexOf(i.stack))) && a.push(i.stack);
                return a
            },
            ...
            getRuler: function() {
                var t, e, i = this._getIndexScale(),
                    ...
                    s = i.isHorizontal(),
                    a = s ? i.left : i.top,
                    r = a + (s ? i.width : i.height),
                    l = [];
                for (t = 0, e = this.getMeta().data.length; t < e; ++t) l.push(i.getPixelForValue(null, t, n));
                return {
                    min: dt.isNullOrUndef(i.options.barThickness) ? function(t, e) {
                        var i, o, n, s, a = t.isHorizontal() ? t.width : t.height,
                            r = t.getTicks();
                        for (n = 1, s = e.length; n < s; ++n) a = Math.min(a, Math.abs(e[n] - e[n - 1]));
                        for (n = 0, s = r.length; n < s; ++n) o = t.getPixelForTick(n), a = 0 < n ? Math.min(a, o - i) : a, i = o;
                        return a
                    }(i, l) : -1,
                    pixels: l,
                    start: a,
            ...
            calculateBarIndexPixels: function(t, e, i) {
                var o, n, s, a, r, l, c, d, h, u, p, f, g, m, v, b, y = i.scale.options,
                    x = "flex" === y.barThickness ? (u = y, f = (h = i).pixels, g = f[e], m = 0 < e ? f[e - 1] : null, v = e < f.length - 1 ? f[e + 1] : null, b = u.categoryPercentage, null === m && (m = g - (null === v ? h.end - h.start : v - g)), null === v && (v = g + g - m), p = g - (g - Math.min(m, v)) / 2 * b, {
                        chunk: Math.abs(v - m) / 2 * b / h.stackCount,
                        ratio: u.barPercentage,
                        start: p
                    }) : (o = e, n = i, l = (s = y).barThickness, c = n.stackCount, d = n.pixels[o], r = dt.isNullOrUndef(l) ? (a = n.min * s.categoryPercentage, s.barPercentage) : (a = l * c, 1), {
                        chunk: a / c,
                        ratio: r,
                        start: d - a / 2
                    }),
                    ...
                    k = Math.min(dt.valueOrDefault(y.maxBarThickness, 1 / 0), x.chunk * x.ratio);
                return {
                    base: w - k / 2,
                    head: w + k / 2,
                    center: w,
            ...
            _resolveElementOptions: function(t, e) {
                var i, o, n, s = this.chart,
                    a = s.data.datasets[this.index],
                    r = t.custom || {},
                    l = s.options.elements.rectangle,
                    c = {},
                    d = {
                        chart: s,
                        dataIndex: e,
                ...
                for (i = 0, o = h.length; i < o; ++i) c[n = h[i]] = Nt([r[n], a[n], l[n]], d, e);
                return c
            }
        }),
    ...
    var Ut = kt.extend({
            ...
            setHoverStyle: function(t) {
                ...
                t.$previousStyle = {
                    ...
                    radius: e.radius
                }, e.backgroundColor = Vt(i.hoverBackgroundColor, o(i.backgroundColor)), e.borderColor = Vt(i.hoverBorderColor, o(i.borderColor)), e.borderWidth = Vt(i.hoverBorderWidth, i.borderWidth), e.radius = i.radius + i.hoverRadius
            },
            _resolveElementOptions: function(t, e) {
                var i, o, n, s = this.chart,
                    a = s.data.datasets[this.index],
                ...
                for (i = 0, o = u.length; i < o; ++i) d[n = u[i]] = Yt([r[n], a[n], l[n]], h, e);
                return d.radius = Yt([r.radius, c ? c.r : void 0, a.radius, l.radius], h, e), d
            }
        }),
    ...
    rt._set("doughnut", {
        ...
        legend: {
            ...
            onClick: function(t, e) {
                var i, o, n, s = e.index,
                    a = this.chart;
                for (i = 0, o = (a.data.datasets || []).length; i < o; ++i)(n = a.getDatasetMeta(i)).data[s] && (n.data[s].hidden = !n.data[s].hidden);
                a.update()
            }
        },
        cutoutPercentage: 50,
    ...
    var Zt = kt.extend({
        ...
        update: function(t) {
            ...
            if (f < 2 * Math.PI) {
                var m = a.rotation % (2 * Math.PI),
                    ...
                    A = .5 * (P - M),
                    L = .5 * (I - $);
                c = Math.min(r / A, l / L), d = {
                    x: -.5 * (P + M),
                    y: -.5 * (I + $)
                }
            }
            for (e = 0, i = u.length; e < i; ++e) u[e]._options = o._resolveElementOptions(u[e], e);
            for (n.borderWidth = o.getMaxBorderWidth(), n.outerRadius = Math.max((c - n.borderWidth) / 2, 0), n.innerRadius = Math.max(p ? n.outerRadius / 100 * p : 0, 0), n.radiusLength = (n.outerRadius - n.innerRadius) / (o._getVisibleDatasetWeightTotal() || 1), n.offsetX = d.x * n.outerRadius, n.offsetY = d.y * n.outerRadius, h.total = o.calculateTotal(), o.outerRadius = n.outerRadius - n.radiusLength * o._getRingWeightOffset(o.index), o.innerRadius = Math.max(o.outerRadius - n.radiusLength * g, 0), e = 0, i = u.length; e < i; ++e) o.updateElement(u[e], e, t)
        },
        updateElement: function(t, e, i) {
            var o = this,
                n = o.chart,
        ...
        setHoverStyle: function(t) {
            ...
            t.$previousStyle = {
                ...
                borderColor: e.borderColor,
                borderWidth: e.borderWidth
            }, e.backgroundColor = Qt(i.hoverBackgroundColor, o(i.backgroundColor)), e.borderColor = Qt(i.hoverBorderColor, o(i.borderColor)), e.borderWidth = Qt(i.hoverBorderWidth, i.borderWidth)
        },
        _resolveElementOptions: function(t, e) {
            var i, o, n, s = this.chart,
                a = this.getDataset(),
                r = t.custom || {},
                l = s.options.elements.arc,
                c = {},
                d = {
                    chart: s,
                    dataIndex: e,
            ...
            for (i = 0, o = h.length; i < o; ++i) c[n = h[i]] = Xt([r[n], a[n], l[n]], d, e);
            return c
        },
    ...
    var ie = kt.extend({
            ...
            updateElement: function(t, e, i) {
                var o, n, s = this,
                    ...
                    u = s.getScaleForId(a.xAxisID),
                    p = a.dataset._model,
                    f = s._resolvePointOptions(t, e);
                o = u.getPixelForValue("object" == typeof d ? d : NaN, e, c), n = i ? h.getBasePixel() : s.calculatePointY(d, e, c), t._xScale = u, t._yScale = h, t._options = f, t._datasetIndex = c, t._index = e, t._model = {
                    x: o,
                    y: n,
            ...
            _resolvePointOptions: function(t, e) {
                var i, o, n, s = this.chart,
                    ...
                    u = Object.keys(h);
                for (i = 0, o = u.length; i < o; ++i) c[n = u[i]] = Jt([r[n], a[h[n]], a[n], l[n]], d, e);
                return c
            },
            _resolveLineOptions: function(t) {
                var e, i, o, n = this.chart,
                    s = n.data.datasets[this.index],
                    a = t.custom || {},
                    r = n.options,
                    l = r.elements.line,
                    c = {},
                ...
                for (e = 0, i = d.length; e < i; ++e) c[o = d[e]] = Jt([a[o], s[o], l[o]]);
                return c.spanGaps = Kt(s.spanGaps, r.spanGaps), c.tension = Kt(s.lineTension, l.tension), c.steppedLine = Jt([a.steppedLine, s.steppedLine, l.stepped]), c
            },
            calculatePointY: function(t, e, i) {
                var o, n, s, a = this.chart,
                    r = this.getMeta(),
                    l = this.getScaleForId(r.yAxisID),
                    c = 0,
                    d = 0;
                if (l.options.stacked) {
                    for (o = 0; o < i; o++)
                        if (n = a.data.datasets[o], "line" === (s = a.getDatasetMeta(o)).type && s.yAxisID === l.id && a.isDatasetVisible(o)) {
            ...
            updateBezierControlPoints: function() {
                ...
                if (n.options.elements.line.capBezierPoints)
                    for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, te(i, r) && (0 < t && te(l[t - 1]._model, r) && (i.controlPointPreviousX = c(i.controlPointPreviousX, r.left, r.right), i.controlPointPreviousY = c(i.controlPointPreviousY, r.top, r.bottom)), t < l.length - 1 && te(l[t + 1]._model, r) && (i.controlPointNextX = c(i.controlPointNextX, r.left, r.right), i.controlPointNextY = c(i.controlPointNextY, r.top, r.bottom)))
            },
            draw: function() {
                var t, e = this.chart,
                    i = this.getMeta(),
                    ...
                    s = o.length,
                    a = 0;
                for (ee(this.getDataset(), e.options) && (t = (i.dataset._model.borderWidth || 0) / 2, dt.canvas.clipArea(e.ctx, {
                        left: n.left,
                        right: n.right,
                        top: n.top - t,
                        bottom: n.bottom + t
            ...
            setHoverStyle: function(t) {
                ...
                t.$previousStyle = {
                    ...
                    borderWidth: e.borderWidth,
                    radius: e.radius
                }, e.backgroundColor = Kt(i.hoverBackgroundColor, o(i.backgroundColor)), e.borderColor = Kt(i.hoverBorderColor, o(i.borderColor)), e.borderWidth = Kt(i.hoverBorderWidth, i.borderWidth), e.radius = Kt(i.hoverRadius, i.radius)
            }
        }),
    ...
    rt._set("polarArea", {
        ...
        legend: {
            ...
            onClick: function(t, e) {
                var i, o, n, s = e.index,
                    a = this.chart;
                for (i = 0, o = (a.data.datasets || []).length; i < o; ++i)(n = a.getDatasetMeta(i)).data[s].hidden = !n.data[s].hidden;
                a.update()
            }
        },
        tooltips: {
    ...
    var ne = kt.extend({
        ...
        _resolveElementOptions: function(t, e) {
            var i, o, n, s = this.chart,
                ...
                h = ["backgroundColor", "borderColor", "borderWidth", "borderAlign", "hoverBackgroundColor", "hoverBorderColor", "hoverBorderWidth"];
            for (i = 0, o = h.length; i < o; ++i) c[n = h[i]] = oe([r[n], a[n], l[n]], d, e);
            return c
        },
    ...
    var le = kt.extend({
        ...
        _resolvePointOptions: function(t, e) {
            var i, o, n, s = this.chart,
                ...
                u = Object.keys(h);
            for (i = 0, o = u.length; i < o; ++i) c[n = u[i]] = re([r[n], a[h[n]], a[n], l[n]], d, e);
            return c
        },
        _resolveLineOptions: function(t) {
            var e, i, o, n = this.chart,
                s = n.data.datasets[this.index],
                a = t.custom || {},
                r = n.options.elements.line,
                l = {},
                c = ["backgroundColor", "borderWidth", "borderColor", "borderCapStyle", "borderDash", "borderDashOffset", "borderJoinStyle", "fill"];
            for (e = 0, i = c.length; e < i; ++e) l[o = c[e]] = re([a[o], s[o], r[o]]);
            return l.tension = ae(s.lineTension, r.tension), l
        },
        updateBezierControlPoints: function() {
        ...
        setHoverStyle: function(t) {
            ...
            t.$previousStyle = {
                ...
                borderWidth: e.borderWidth,
                radius: e.radius
            }, e.backgroundColor = ae(i.hoverBackgroundColor, o(i.backgroundColor)), e.borderColor = ae(i.hoverBorderColor, o(i.borderColor)), e.borderWidth = ae(i.hoverBorderWidth, i.borderWidth), e.radius = ae(i.hoverRadius, i.radius)
        }
    });
    rt._set("scatter", {
        hover: {
    ...
    function he(t, e) {
        var i, o, n, s, a;
        for (o = 0, s = t.data.datasets.length; o < s; ++o)
    ...
    var xe, _e = {
            ...
            update: function(e, i, t) {
                if (e) {
                    ...
                    dt.each(v, function(t) {
                    ...
                    }), A = v, O = D = F = L = 0, dt.each(A, function(t) {
                        if (t.getPadding) {
                            var e = t.getPadding();
                            L = Math.max(L, e.top), F = Math.max(F, e.left), D = Math.max(D, e.bottom), O = Math.max(O, e.right)
                        }
                    }), f = {
                        top: L,
                        left: F,
                        bottom: D,
                        right: O
                    }, dt.each(g, z), ye(g, k), dt.each(m, z), ye(m, k), dt.each(g, function(e) {
                    ...
                    k.left += C, k.right += Math.max(f.right - k.right, 0);
                    var T = Math.max(f.top - k.top, 0);
                    k.top += T, k.bottom += Math.max(f.bottom - k.bottom, 0);
                    ...
                    var P = s + C,
                        I = r + T;
                    dt.each(c.concat(h), E), P += _, I += w, dt.each(d, E), dt.each(u, E), e.chartArea = {
                        left: k.left,
                        top: k.top,
                        right: k.left + _,
                        bottom: k.top + w
    ...
    function De(i, o, n) {
        var t, e, s, a, r, l, c, d = i[ke] || (i[ke] = {}),
            h = d.resizer = function(t) {
                var e = Fe(Se),
                    i = Fe(Se + "-expand"),
                    o = Fe(Se + "-shrink");
                i.appendChild(Fe()), o.appendChild(Fe()), e.appendChild(i), e.appendChild(o), e._reset = function() {
                ...
                return Ie(i, "scroll", n.bind(i, "expand")), Ie(o, "scroll", n.bind(o, "shrink")), e
            }((s = !(t = function() {
                if (d.resizer) {
                    var t = n.options.maintainAspectRatio && i.parentNode,
                        e = t ? t.clientWidth : 0;
                    o(Le("resize", n)), t && t.clientWidth < e && n.canvas && o(Le("resize", n))
                }
            }), a = [], function() {
        ...
        l = (r = i)[ke] || (r[ke] = {}), c = l.renderProxy = function(t) {
            ...
            Ie(r, t, c)
        }), l.reflow = !!r.offsetParent, r.classList.add(Ce)
    }
    var Oe = {
        ...
        addEventListener: function(s, t, a) {
            ...
            if ("resize" !== t) {
                ...
                Ie(e, t, (i.proxies || (i.proxies = {}))[s.id + "_" + t] = function(t) {
                    var e, i, o, n;
                    a((i = s, o = Me[(e = t).type] || e.type, n = dt.getRelativePosition(e, i), Le(o, i, n.x, n.y, e)))
                })
            } else De(e, a, s)
        },
        removeEventListener: function(t, e, i) {
            ...
            if ("resize" !== e) {
                ...
                d && Ae(c, e, d)
            } else r = (o = c)[ke] || {}, l = r.resizer, delete r.resizer, s = (n = o)[ke] || {}, (a = s.renderProxy) && (dt.each(Te, function(t) {
                Ae(n, t, a)
            }), delete s.renderProxy), n.classList.remove(Ce), l && l.parentNode && l.parentNode.removeChild(l)
        }
    };
    dt.addEvent = Ie, dt.removeEvent = Ae;
    ...
    var Re = {
            ...
            notify: function(t, e, i) {
                var o, n, s, a, r, l = this.descriptors(t),
                    c = l.length;
                for (o = 0; o < c; ++o)
                    if ("function" == typeof(r = (s = (n = l[o]).plugin)[e]) && ((a = [t].concat(i || [])).push(n.options), !1 === r.apply(s, a))) return !1;
                return !0
            },
            descriptors: function(t) {
                ...
                return this._plugins.concat(i.plugins || []).forEach(function(t) {
                    if (-1 === o.indexOf(t)) {
                        var e = t.id,
                            i = s[e];
                        !1 !== i && (!0 === i && (i = dt.clone(rt.global.plugins[e])), o.push(t), n.push({
                            plugin: t,
                            options: i || {}
                        }))
                    }
    ...
    var Ue = gt.extend({
            ...
            getTitle: function() {
                var t = this._options.callbacks,
                    ...
                    n = [];
                return n = Be(n, Ne(e)), n = Be(n, Ne(i)), Be(n, Ne(o))
            },
            ...
            getBody: function(t, i) {
                ...
                return dt.each(t, function(t) {
                    ...
                    Be(e.before, Ne(n.beforeLabel.call(o, t, i))), Be(e.lines, n.label.call(o, t, i)), Be(e.after, Ne(n.afterLabel.call(o, t, i))), s.push(e)
                }), s
            },
            ...
            update: function(t) {
                var e, i, o, n, s, a, r, l, c, d, h, u, p, f, g, m, v, b, y, x, _, w, k, S = this,
                    C = S._options,
                    T = S._model,
                    M = S._model = qe(C),
                    $ = S._active,
                ...
                if ($.length) {
                    ...
                    var z = [];
                    for (e = 0, i = $.length; e < i; ++e) z.push((d = c = l = s = n = void 0, n = (o = $[e])._xScale, s = o._yScale || o._scale, a = o._index, r = o._datasetIndex, c = (l = o._chart.getDatasetMeta(r).controller)._getIndexScale(), d = l._getValueScale(), {
                    ...
                    C.filter && (z = z.filter(function(t) {
                        ...
                        D.push(C.callbacks.labelColor.call(S, t, S._chart)), O.push(C.callbacks.labelTextColor.call(S, t, S._chart))
                    }), M.title = S.getTitle(z, P), M.beforeBody = S.getBeforeBody(z, P), M.body = S.getBody(z, P), M.afterBody = S.getAfterBody(z, P), M.footer = S.getFooter(z, P), M.x = F.x, M.y = F.y, M.caretPadding = C.caretPadding, M.labelColors = D, M.labelTextColors = O, M.dataPoints = z, L = function(t, e) {
                        var i = t._chart.ctx,
                            o = 2 * e.yPadding,
                            n = 0,
                            s = e.body,
                    ...
                    }(this, M), h = M, p = I = function(t, e) {
                        var i, o, n, s, a, r = t._model,
                            l = t._chart,
                        ...
                        }, i(r.x) ? (d = "left", n(r.x) && (d = "center", h = a(r.y))) : o(r.x) && (d = "right", s(r.x) && (d = "center", h = a(r.y)));
                        var f = t._options;
                        return {
                            xAlign: f.xAlign ? f.xAlign : d,
                            yAlign: f.yAlign ? f.yAlign : h
                        }
                    }(this, u = L), f = S._chart, g = h.x, m = h.y, v = h.caretSize, b = h.caretPadding, y = h.cornerRadius, x = p.xAlign, _ = p.yAlign, w = v + b, k = y + b, "right" === x ? g -= u.width : "center" === x && ((g -= u.width / 2) + u.width > f.width && (g = f.width - u.width), g < 0 && (g = 0)), "top" === _ ? m += w : m -= "bottom" === _ ? u.height + w : u.height / 2, "center" === _ ? "left" === x ? g += w : "right" === x && (g -= w) : "left" === x ? g -= k : "right" === x && (g += k), A = {
                        x: g,
                        y: m
                    }
                } else M.opacity = 0;
                return M.xAlign = I.xAlign, M.yAlign = I.yAlign, M.x = A.x, M.y = A.y, M.width = L.width, M.height = L.height, M.caretX = F.x, M.caretY = F.y, S._model = M, t && C.custom && C.custom.call(S, M), S
            },
            ...
            getCaretPosition: function(t, e, i) {
                var o, n, s, a, r, l, c = i.caretSize,
                    ...
                    g = e.width,
                    m = e.height;
                if ("center" === u) r = f + m / 2, l = "left" === h ? (n = (o = p) - c, s = o, a = r + c, r - c) : (n = (o = p + g) + c, s = o, a = r - c, r + c);
                else if (s = (o = "left" === h ? (n = p + d + c) - c : "right" === h ? (n = p + g - d - c) - c : (n = i.caretX) - c, n + c), "top" === u) r = (a = f) - c, l = a;
                else {
                    r = (a = f + m) + c, l = a;
                    var v = s;
                    s = o, o = v
            ...
            drawTitle: function(t, e, i) {
                var o = e.title;
                if (o.length) {
                    t.x = Ve(e, e._titleAlign), i.textAlign = e._titleAlign, i.textBaseline = "top";
            ...
            drawBody: function(i, o, n) {
                var s, a = o.bodyFontSize,
                    ...
                    d = 0,
                    h = l ? Ve(o, "left") : 0;
                n.textAlign = t, n.textBaseline = "top", n.font = dt.fontString(a, o._bodyFontStyle, o._bodyFontFamily), i.x = Ve(o, t);
            ...
            drawFooter: function(e, i, o) {
                var t = i.footer;
                t.length && (e.x = Ve(i, i._footerAlign), e.y += i.footerMarginTop, o.textAlign = i._footerAlign, o.textBaseline = "top", o.fillStyle = i.footerFontColor, o.font = dt.fontString(i.footerFontSize, i._footerFontStyle, i._footerFontFamily), dt.each(t, function(t) {
            ...
            draw: function() {
                ...
                if (0 !== e.opacity) {
                    ...
                    this._options.enabled && s && (t.save(), t.globalAlpha = n, this.drawBackground(o, e, t, i), o.y += e.yPadding, this.drawTitle(o, e, t), this.drawBody(o, e, t), this.drawFooter(o, e, t), t.restore())
                }
            },
        ...
        return dt.merge({}, [].slice.call(arguments), {
            merger: function(t, e, i, o) {
                if ("xAxes" === t || "yAxes" === t) {
                    ...
                    for (e[t] || (e[t] = []), n = 0; n < r; ++n) a = i[t][n], s = Ze(a.type, "xAxes" === t ? "category" : "linear"), n >= e[t].length && e[t].push({}), !e[t][n].type || a.type && a.type !== e[t][n].type ? dt.merge(e[t][n], [We.getScaleDefaults(s), a]) : dt.merge(e[t][n], a)
    ...
    dt.extend(ti.prototype, {
        construct: function(t, e) {
            var i, o, n = this;
            (o = (i = (i = e) || {}).data = i.data || {}).datasets = o.datasets || [], o.labels = o.labels || [], i.options = Ke(rt.global, rt[i.type], i.options || {}), e = i;
            var s = Ee.acquireContext(t, e),
                a = s && s.canvas,
                r = a && a.height,
                l = a && a.width;
            n.id = dt.uid(), n.ctx = s, n.canvas = a, n.config = e, n.width = l, n.height = r, n.aspectRatio = r ? l / r : null, n.options = e.options, n._bufferedRender = !1, (n.chart = n).controller = n, ti.instances[n.id] = n, Object.defineProperty(n, "data", {
                get: function() {
        ...
        initialize: function() {
            var t = this;
            return Re.notify(t, "beforeInit"), dt.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), Re.notify(t, "afterInit"), t
        },
        clear: function() {
        ...
        resize: function(t) {
            ...
            if ((e.width !== s || e.height !== a) && (o.width = e.width = s, o.height = e.height = a, o.style.width = s + "px", o.style.height = a + "px", dt.retinaScale(e, i.devicePixelRatio), !t)) {
                var r = {
                    width: s,
                    height: a
                };
                Re.notify(e, "resize", [r]), i.onResize && i.onResize(e, r), e.stop(), e.update({
        ...
        buildOrUpdateScales: function() {
            ...
            t.scales && (e = e.concat((t.scales.xAxes || []).map(function(t) {
                ...
                t || delete r[e]
            }), a.scales = r, We.addScalesToLayout(this)
        },
        ...
        update: function(t) {
            ...
            if (t && "object" == typeof t || (t = {
                    duration: t,
                    lazy: arguments[1]
                }), i = (e = o).options, dt.each(e.scales, function(t) {
                    _e.removeBox(e, t)
                }), i = Ke(rt.global, rt[e.config.type], i), e.options = e.config.options = i, e.ensureScalesHaveIDs(), e.buildOrUpdateScales(), e.tooltip._options = i.tooltips, e.tooltip.initialize(), Re._invalidate(o), !1 !== Re.notify(o, "beforeUpdate")) {
                o.tooltip._data = o.data;
                var n = o.buildOrUpdateControllers();
                dt.each(o.data.datasets, function(t, e) {
                    o.getDatasetMeta(e).controller.buildOrUpdateElements()
                }, o), o.updateLayout(), o.options.animation && o.options.animation.duration && dt.each(n, function(t) {
                    t.reset()
                }), o.updateDatasets(), o.tooltip.initialize(), o.lastActive = [], Re.notify(o, "afterUpdate"), o._bufferedRender ? o._bufferedRequest = {
                    duration: t.duration,
                    easing: t.easing,
                    lazy: t.lazy
                } : o.render(t)
        ...
        updateLayout: function() {
            !1 !== Re.notify(this, "beforeLayout") && (_e.update(this, this.width, this.height), Re.notify(this, "afterScaleUpdate"), Re.notify(this, "afterLayout"))
        },
        ...
        updateDataset: function(t) {
            ...
            !1 !== Re.notify(this, "beforeDatasetUpdate", [i]) && (e.controller.update(), Re.notify(this, "afterDatasetUpdate", [i]))
        },
        render: function(t) {
            var e = this;
            t && "object" == typeof t || (t = {
            ...
            if (!1 !== Re.notify(e, "beforeRender")) {
                var s = function(t) {
                    Re.notify(e, "afterRender"), dt.callback(i && i.onComplete, [t], e)
                };
                if (i && o) {
                    var a = new vt({
                        numSteps: o / 16.66,
        ...
        draw: function(t) {
            var e = this;
            e.clear(), dt.isNullOrUndef(t) && (t = 1), e.transition(t), e.width <= 0 || e.height <= 0 || !1 !== Re.notify(e, "beforeDraw", [t]) && (dt.each(e.boxes, function(t) {
                t.draw(e.chartArea)
            }, e), e.drawDatasets(t), e._drawTooltip(t), Re.notify(e, "afterDraw", [t]))
        },
        transition: function(t) {
        ...
        drawDataset: function(t, e) {
            ...
            !1 !== Re.notify(this, "beforeDatasetDraw", [o]) && (i.controller.draw(e), Re.notify(this, "afterDatasetDraw", [o]))
        },
        _drawTooltip: function(t) {
            ...
            !1 !== Re.notify(this, "beforeTooltipDraw", [i]) && (e.draw(), Re.notify(this, "afterTooltipDraw", [i]))
        },
        ...
        destroy: function() {
            ...
            o && (i.unbindEvents(), dt.canvas.clear(i), Ee.releaseContext(i.ctx), i.canvas = null, i.ctx = null), Re.notify(i, "destroy"), delete ti.instances[i.id]
        },
        ...
        bindEvents: function() {
            ...
            dt.each(e.options.events, function(t) {
                Ee.addEventListener(e, t, o), i[t] = o
            }), e.options.responsive && (o = function() {
                e.resize()
            }, Ee.addEventListener(e, "resize", o), i.resize = o)
        },
        ...
        updateHoverStyle: function(t, e, i) {
            ...
            for (n = 0, s = t.length; n < s; ++n)(o = t[n]) && this.getDatasetMeta(o._datasetIndex).controller[a](o)
        },
        eventHandler: function(t) {
            ...
            if (!1 !== Re.notify(e, "beforeEvent", [t])) {
                ...
                i && (o = i._start ? i.handleEvent(t) : o | i.handleEvent(t)), Re.notify(e, "afterEvent", [t]);
    ...
    function oi(t) {
        this.options = t || {}
    }(ti.Controller = ti).types = {}, dt.configMerge = Ke, dt.scaleMerge = Ge, dt.extend(oi.prototype, {
        formats: ii,
        parse: ii,
        format: ii,
        add: ii,
    ...
    var di = gt.extend({
            ...
            calculateTickRotation: function() {
                ...
                if (o.length && t.options.display && t.isHorizontal())
                    for (var a, r = dt.longestText(e, n.string, o, t.longestTextCache), l = r, c = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; c < l && s < i.maxRotation;) {
                        ...
                        if (a = Math.cos(d), Math.sin(d) * r > t.maxHeight) {
                            s--;
                            break
                        }
                        s++, l = a * r
            ...
            fit: function() {
                ...
                if (e.width = c ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : r && a.drawTicks ? u : 0, e.height = c ? r && a.drawTicks ? u : 0 : t.maxHeight, s.display && r) {
                    var p = d(s),
                ...
                if (n.display && r) {
                    ...
                    if (t._maxLabelLines = v, t.longestLabelWidth = m, c) {
                        ...
                        e.height = Math.min(t.maxHeight, e.height + w + y), t.ctx.font = h.string;
                        var k, S, C = ci(t.ctx, i[0], h.string),
                            T = ci(t.ctx, i[i.length - 1], h.string),
                            M = t.getPixelForTick(0) - t.left,
                            $ = t.right - t.getPixelForTick(i.length - 1);
                        S = 0 !== t.labelRotation ? (k = "bottom" === l ? _ * C : _ * b, "bottom" === l ? _ * b : _ * T) : (k = C / 2, T / 2), t.paddingLeft = Math.max(k - M, 0) + 3, t.paddingRight = Math.max(S - $, 0) + 3
                    } else n.mirror ? m = 0 : m += y + b, e.width = Math.min(t.maxWidth, e.width + m), t.paddingTop = h.size / 2, t.paddingBottom = h.size / 2
                }
            ...
            draw: function(M) {
                ...
                if ($._isVisible()) {
                    var t, I, A, L = $.chart,
                        ...
                        z = r.mirror,
                        E = $.isHorizontal(),
                        n = dt.options._parseFont,
                        s = r.display && r.autoSkip ? $._autoSkip($.getTicks()) : $.getTicks(),
                        l = ai(r.fontColor, e),
                        c = n(r),
                        R = c.lineHeight,
                        d = ai(i.fontColor, e),
                        ...
                        W = r.padding,
                        H = r.labelOffset,
                        j = F.drawTicks ? F.tickMarkLength : 0,
                        u = ai(o.fontColor, e),
                        p = n(o),
                        f = dt.options.toPadding(o.padding),
                        B = dt.toRadians($.labelRotation),
                        N = [],
                        q = F.drawBorder ? ri(F.lineWidth, 0, 0) : 0,
                        V = dt._alignPixel;
                    if (A = "top" === D ? (t = V(L, $.bottom, q), I = $.bottom - j, t - q / 2) : "bottom" === D ? (t = V(L, $.top, q), I = t + q / 2, $.top + j) : "left" === D ? (t = V(L, $.right, q), I = $.right - j, t - q / 2) : (t = V(L, $.left, q), I = t + q / 2, $.left + j), dt.each(s, function(t, e) {
                            if (!dt.isNullOrUndef(t.label)) {
                                var i, o, n, s, a, r, l, c, d, h, u, p, f, g, m, v, b = t.label;
                                s = e === $.zeroLineIndex && P.offset === F.offsetGridLines ? (i = F.zeroLineWidth, o = F.zeroLineColor, n = F.zeroLineBorderDash || [], F.zeroLineBorderDashOffset || 0) : (i = ri(F.lineWidth, e), o = ri(F.color, e), n = F.borderDash || [], F.borderDashOffset || 0);
                                var y = dt.isArray(b) ? b.length : 1,
                                    x = (k = $, S = e, C = F.offsetGridLines, T = k.getPixelForTick(S), C && (1 === k.getTicks().length ? T -= k.isHorizontal() ? Math.max(T - k.left, k.right - T) : Math.max(T - k.top, k.bottom - T) : T -= 0 === S ? (k.getPixelForTick(1) - T) / 2 : (T - k.getPixelForTick(S - 1)) / 2), T);
                                if (E) {
                                    var _ = j + W;
                                    x < $.left - 1e-7 && (o = "rgba(0,0,0,0)"), a = l = d = u = V(L, x, i), r = I, c = A, f = $.getPixelForTick(e) + H, g = "top" === D ? (h = V(L, M.top, q) + q / 2, p = M.bottom, m = ((O ? 1 : .5) - y) * R, v = O ? "left" : "center", $.bottom - _) : (h = M.top, p = V(L, M.bottom, q) - q / 2, m = (O ? 0 : .5) * R, v = O ? "right" : "center", $.top + _)
                                } else {
                                    var w = (z ? 0 : j) + W;
                                    x < $.top - 1e-7 && (o = "rgba(0,0,0,0)"), a = I, l = A, r = c = h = p = V(L, x, i), g = $.getPixelForTick(e) + H, m = (1 - y) * R / 2, f = "left" === D ? (d = V(L, M.left, q) + q / 2, u = M.right, v = z ? "left" : "right", $.right - w) : (d = M.left, u = V(L, M.right, q) - q / 2, v = z ? "right" : "left", $.left + w)
                                }
                                N.push({
                                    tx1: a,
                                    ty1: r,
                            ...
                            var e = t.glWidth,
                                i = t.glColor;
                            if (F.display && e && i && (a.save(), a.lineWidth = e, a.strokeStyle = i, a.setLineDash && (a.setLineDash(t.glBorderDash), a.lineDashOffset = t.glBorderDashOffset), a.beginPath(), F.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)), F.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)), a.stroke(), a.restore()), r.display) {
                                ...
                                var o = t.label,
                                    n = t.textOffset;
                                if (dt.isArray(o))
                                    for (var s = 0; s < o.length; ++s) a.fillText("" + o[s], 0, n), n += R;
                        ...
                        var g, m, v = 0,
                            b = p.lineHeight / 2;
                        if (E) g = $.left + ($.right - $.left) / 2, m = "bottom" === D ? $.bottom - b - f.bottom : $.top + b + f.top;
                        else {
                            var y = "left" === D;
                            g = y ? $.left + b + f.top : $.right - b - f.top, m = $.top + ($.bottom - $.top) / 2, v = y ? -.5 * Math.PI : .5 * Math.PI
                        }
                        a.save(), a.translate(g, m), a.rotate(v), a.textAlign = "center", a.textBaseline = "middle", a.fillStyle = u, a.font = p.string, a.fillText(o.labelString, 0, 0), a.restore()
                    }
                    if (q) {
                        var x, _, w, k, S = q,
                            C = ri(F.lineWidth, s.length - 1, 0);
                        E ? (x = V(L, $.left, S) - S / 2, _ = V(L, $.right, C) + C / 2, w = k = t) : (w = V(L, $.top, S) - S / 2, k = V(L, $.bottom, C) + C / 2, x = _ = t), a.lineWidth = q, a.strokeStyle = ri(F.color, 0), a.beginPath(), a.moveTo(x, w), a.lineTo(_, k), a.stroke()
                    }
                }
            }
        }),
        hi = di.extend({
            ...
            getPixelForValue: function(t, e) {
                var i, o = this,
                    n = o.options.offset,
                    s = Math.max(o.maxIndex + 1 - o.minIndex - (n ? 0 : 1), 1);
                ...
                if (o.isHorizontal()) {
                    var r = o.width / s,
                        l = r * (e - o.minIndex);
                    return n && (l += r / 2), o.left + l
                }
                var c = o.height / s,
                    d = c * (e - o.minIndex);
                return n && (d += c / 2), o.top + d
            },
            getPixelForTick: function(t) {
    ...
    var ui = dt.noop,
        pi = dt.isNullOrUndef,
            ...
            buildTicks: function() {
                var g = this,
                    ...
                    i = g.ticks = function() {
                        ...
                        if (p < 1e-14 && pi(l) && pi(c)) return [h, u];
                        (o = Math.ceil(u / p) - Math.floor(h / p)) > r && (p = dt.niceNum(o * p / r / a) * a), s || pi(d) ? t = Math.pow(10, dt._decimalPlaces(p)) : (t = Math.pow(10, d), p = Math.ceil(p * t) / t), e = Math.floor(h / p) * p, i = Math.ceil(u / p) * p, s && (!pi(l) && dt.almostWhole(l / p, p / 1e3) && (e = l), !pi(c) && dt.almostWhole(c / p, p / 1e3) && (i = c)), o = (i - e) / p, o = dt.almostEquals(o, Math.round(o), p / 1e3) ? Math.round(o) : Math.ceil(o), e = Math.round(e * t) / t, i = Math.round(i * t) / t, n.push(pi(l) ? e : l);
                        for (var f = 1; f < o; ++f) n.push(Math.round((e + f * p) * t) / t);
                        return n.push(pi(c) ? i : c), n
                    }();
            ...
            convertTicksToLabels: function() {
                var t = this;
                t.ticksAsNumbers = t.ticks.slice(), t.zeroLineIndex = t.ticks.indexOf(0), di.prototype.convertTicksToLabels.call(t)
            }
        }),
        gi = {
            position: "left",
    ...
    var _i = di.extend({
                ...
                if (void 0 === o && dt.each(t, function(t, e) {
                    ...
                    dt.each(t, function(t, e) {
                        ...
                        if (0 < t.length) {
                            var e = dt.min(t),
                                i = dt.max(t);
                            a.min = null === a.min ? e : Math.min(a.min, e), a.max = null === a.max ? i : Math.max(a.max, i)
                        }
                    })
                } else dt.each(t, function(t, e) {
            ...
            handleTickRangeOptions: function() {
                var t = this,
                    e = t.options.ticks;
                t.min = xi(e.min, t.min), t.max = xi(e.max, t.max), t.min === t.max && (0 !== t.min && null !== t.min ? (t.min = Math.pow(10, Math.floor(dt.log10(t.min)) - 1), t.max = Math.pow(10, Math.floor(dt.log10(t.max)) + 1)) : (t.min = 1, t.max = 10)), null === t.min && (t.min = Math.pow(10, Math.floor(dt.log10(t.max)) - 1)), null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(dt.log10(t.min)) + 1) : 10), null === t.minNotZero && (0 < t.min ? t.minNotZero = t.min : t.max < 1 ? t.minNotZero = Math.pow(10, Math.floor(dt.log10(t.max))) : t.minNotZero = 1)
            },
            buildTicks: function() {
                var t = this,
                    e = t.options.ticks,
                    ...
                    n = t.ticks = function(t, e) {
                        var i, o, n = [],
                            s = bi(t.min, Math.pow(10, Math.floor(dt.log10(e.min)))),
            ...
            getPixelForValue: function(t) {
                var e, i, o, n, s, a = this,
                    ...
                    h = 0;
                return t = +a.getRightValue(t), s = l ? (o = a.end, n = a.start, -1) : (o = a.start, n = a.end, 1), i = a.isHorizontal() ? (e = a.width, l ? a.right : a.left) : (e = a.height, s *= -1, l ? a.top : a.bottom), t !== o && (0 === o && (e -= h = bi(r.fontSize, rt.global.defaultFontSize), o = d), 0 !== t && (h += e / (c(n) - c(o)) * (c(t) - c(o))), i += s * h), i
            },
            getValueForPixel: function(t) {
                var e, i, o, n, s = this,
                    a = s.options.ticks,
                ...
                if (o = r ? (i = s.end, s.start) : (i = s.start, s.end), (n = s.isHorizontal() ? (e = s.width, r ? s.right - t : t - s.left) : (e = s.height, r ? t - s.top : s.bottom - t)) !== i) {
                    if (0 === i) {
                        var d = bi(a.fontSize, rt.global.defaultFontSize);
                        n -= d, e -= d, i = c
                    }
                    n *= l(o) - l(i), n /= e, n = Math.pow(10, l(i) + n)
                }
                return n
            }
        }),
    ...
    var Li = fi.extend({
            setDimensions: function() {
                var t = this;
                t.width = t.maxWidth, t.height = t.maxHeight, t.paddingTop = $i(t.options) / 2, t.xCenter = Math.floor(t.width / 2), t.yCenter = Math.floor((t.height - t.paddingTop) / 2), t.drawingArea = Math.min(t.height - t.paddingTop, t.width) / 2
            },
            determineDataLimits: function() {
                var n = this,
                    i = n.chart,
            ...
            convertTicksToLabels: function() {
                var t = this;
                fi.prototype.convertTicksToLabels.call(t), t.pointLabels = t.chart.data.labels.map(t.options.pointLabels.callback, t)
            },
            getLabelForIndex: function(t, e) {
                return +this.getRightValue(this.chart.data.datasets[e].data[t])
            },
            fit: function() {
                ...
                t.display && t.pointLabels.display ? function(t) {
                    var e, i, o, n = dt.options._parseFont(t.options.pointLabels),
                        s = {
                            l: 0,
                            r: t.width,
                            t: 0,
                        ...
                        a = {};
                    t.ctx.font = n.string, t._pointLabelSizes = [];
                    var r, l, c, d = Mi(t);
                    for (e = 0; e < d; e++) {
                        o = t.getPointPosition(e, t.drawingArea + 5), r = t.ctx, l = n.lineHeight, c = t.pointLabels[e] || "", i = dt.isArray(c) ? {
                        ...
                        p.start < s.l && (s.l = p.start, a.l = h), p.end > s.r && (s.r = p.end, a.r = h), f.start < s.t && (s.t = f.start, a.t = h), f.end > s.b && (s.b = f.end, a.b = h)
                    }
            ...
            setReductions: function(t, e, i) {
                ...
                n = Ai(n), s = Ai(s), a = Ai(a), r = Ai(r), o.drawingArea = Math.min(Math.floor(t - (n + s) / 2), Math.floor(t - (a + r) / 2)), o.setCenterPoint(n, s, a, r)
            },
                ...
                if (t.display) {
                    ...
                    (t.angleLines.display || t.pointLabels.display) && function(t) {
                        var e = t.ctx,
                            ...
                            l = $i(i);
                        e.save(), e.lineWidth = a, e.strokeStyle = r, e.setLineDash && (e.setLineDash(Ci([o.borderDash, n.borderDash, []])), e.lineDashOffset = Ci([o.borderDashOffset, n.borderDashOffset, 0]));
                        var c, d, h, u, p = t.getDistanceFromCenterForValue(i.ticks.reverse ? t.min : t.max),
                            f = dt.options._parseFont(s);
                        e.font = f.string, e.textBaseline = "middle";
                        for (var g = Mi(t) - 1; 0 <= g; g--) {
                            ...
                            if (s.display) {
                                ...
                                var x = t.getIndexAngle(g),
                                    _ = dt.toDegrees(x);
                                e.textAlign = 0 === (u = _) || 180 === u ? "center" : u < 180 ? "left" : "right", c = _, d = t._pointLabelSizes[g], h = b, 90 === c || 270 === c ? h.y -= d.h / 2 : (270 < c || c < 90) && (h.y -= d.h), Ii(e, t.pointLabels[g] || "", b, f.lineHeight)
                            }
                        }
                        e.restore()
                    }(s), dt.each(s.ticks, function(t, e) {
                        if (0 < e || r.reverse) {
                            ...
                            if (a.display && 0 !== e && function(t, e, i, o) {
                                ...
                                if (l.font = d.string, l.save(), l.translate(s.xCenter, s.yCenter), l.rotate(c), r.showLabelBackdrop) {
                                    var n = l.measureText(t).width;
                                    l.fillStyle = r.backdropColor, l.fillRect(-n / 2 - r.backdropPaddingX, -i - d.size / 2 - r.backdropPaddingY, n + 2 * r.backdropPaddingX, d.size + 2 * r.backdropPaddingY)
                                }
                                l.textAlign = "center", l.textBaseline = "middle", l.fillStyle = o, l.fillText(t, 0, -i), l.restore()
                            }
                        }
                    })
                }
    ...
    function Hi(t) {
        var e, i, o, n = {},
            s = [];
        for (e = 0, i = t.length; e < i; ++e) n[o = t[e]] || (n[o] = !0, s.push(o));
        return s
    }
    ...
    var Vi = di.extend({
        ...
        determineDataLimits: function() {
            var t, e, i, o, n, s, a = this,
                ...
                g = [],
                m = r.data.labels || [];
            for (t = 0, i = m.length; t < i; ++t) g.push(Ni(a, m[t]));
            for (t = 0, i = (r.data.datasets || []).length; t < i; ++t)
                if (r.isDatasetVisible(t))
                    if (n = r.data.datasets[t].data, dt.isObject(n[0]))
                        for (f[t] = [], e = 0, o = n.length; e < o; ++e) s = Ni(a, n[e]), p.push(s), f[t][e] = s;
                    else {
                        for (e = 0, o = g.length; e < o; ++e) p.push(g[e]);
                        f[t] = g.slice(0)
                    }
            else f[t] = [];
            g.length && (g = Hi(g).sort(Wi), h = Math.min(h, g[0]), u = Math.max(u, g[g.length - 1])), p.length && (p = Hi(p).sort(Wi), h = Math.min(h, p[0]), u = Math.max(u, p[p.length - 1])), h = Ni(a, c.min) || h, u = Ni(a, c.max) || u, h = h === zi ? +l.startOf(Date.now(), d) : h, u = u === Oi ? +l.endOf(Date.now(), d) + 1 : u, a.min = Math.min(h, u), a.max = Math.max(h + 1, u), a._horizontal = a.isHorizontal(), a._table = [], a._timestamps = {
                data: p,
                datasets: f,
                labels: g
            }
                ...
                default:
                    g = function(t, l, c, e) {
                        var i, o = t._adapter,
                            ...
                            d = s.unit || function(t, e, i, o) {
                                ...
                                for (n = Ri.indexOf(t); n < r - 1; ++n)
                                    if (a = (s = Ei[Ri[n]]).steps ? s.steps[s.steps.length - 1] : zi, s.common && Math.ceil((i - e) / (a * s.size)) <= o) return Ri[n];
                                return Ri[r - 1]
                            }(s.minUnit, l, c, e),
                            a = qi(d),
                            r = Di(s.stepSize, s.unitStepSize),
                        ...
                        for (r = r || function(t) {
                                ...
                                return o
                            }(e), h && (f = +o.startOf(f, "isoWeek", h), g = +o.startOf(g, "isoWeek", h)), f = +o.startOf(f, h ? "day" : d), (g = +o.startOf(g, h ? "day" : d)) < c && (g = +o.add(g, 1, d)), i = f, u && a && !h && !s.round && (i = +o.startOf(i, a), i = +o.add(i, ~~((f - i) / (p.size * r)) * r, d)); i < g; i = +o.add(i, r, d)) m.push(+i);
                        return m.push(+i), m
                    }(d, h, u, d.getLabelCapacity(h))
            }
            for ("ticks" === p.bounds && g.length && (h = g[0], u = g[g.length - 1]), h = Ni(d, f.min) || h, u = Ni(d, f.max) || u, t = 0, e = g.length; t < e; ++t)(i = g[t]) >= h && i <= u && m.push(i);
            return d.min = h, d.max = u, d._unit = f.unit || function(t, e, i, o, n) {
                    var s, a;
                    for (s = Ri.length - 1; s >= Ri.indexOf(i); s--)
                        if (a = Ri[s], Ei[a].common && t._adapter.diff(n, o, a) >= e.length) return a;
                    return Ri[i ? Ri.indexOf(i) : 0]
                }(d, m, f.minUnit, d.min, d.max), d._majorUnit = qi(d._unit), d._table = function(t, e, i) {
                    ...
                    var o, n, s, a, r, l = [],
                        c = [e];
                    for (o = 0, n = t.length; o < n; ++o)(a = t[o]) > e && a < i && c.push(a);
                    for (c.push(i), o = 0, n = c.length; o < n; ++o) r = c[o + 1], s = c[o - 1], a = c[o], void 0 !== s && void 0 !== r && Math.round((r + s) / 2) === a || l.push({
                        time: a,
                        pos: o / (n - 1)
                    });
                    return l
                }(d._timestamps.data, h, u), d._offsets = (o = d._table, n = m, c = l = 0, (s = p).offset && n.length && (s.time.min || (a = ji(o, "time", n[0], "pos"), l = 1 === n.length ? 1 - a : (ji(o, "time", n[1], "pos") - a) / 2), s.time.max || (r = ji(o, "time", n[n.length - 1], "pos"), c = 1 === n.length ? r : (r - ji(o, "time", n[n.length - 2], "pos")) / 2)), {
                    start: l,
                    end: c
                }), p.ticks.reverse && m.reverse(),
                function(t, e, i) {
                    var o, n, s, a, r = [];
                    for (o = 0, n = e.length; o < n; ++o) s = e[o], a = !!i && s === +t._adapter.startOf(s, i), r.push({
                        value: s,
                        major: a
                    });
                    return r
        ...
        getLabelForIndex: function(t, e) {
            ...
            return dt.isObject(r) && (a = i.getRightValue(r)), s.tooltipFormat ? o.format(Bi(i, a), s.tooltipFormat) : "string" == typeof a ? a : o.format(Bi(i, a), s.displayFormats.datetime)
        },
        ...
        convertTicksToLabels: function(t) {
            var e, i, o = [];
            for (e = 0, i = t.length; e < i; ++e) o.push(this.tickFormatFunction(t[e].value, e, t));
            return o
        },
        ...
        getPixelForValue: function(t, e, i) {
            var o = null;
            if (void 0 !== e && void 0 !== i && (o = this._timestamps.datasets[i][e]), null === o && (o = Ni(this, t)), null !== o) return this.getPixelForOffset(o)
        },
        getPixelForTick: function(t) {
            var e = this.getTicks();
    ...
    var to = {
            ...
            afterDatasetsUpdate: function(t, e) {
                var i, o, n, s, a, r, l, c = (t.data.datasets || []).length,
                    d = e.propagate,
                    h = [];
                for (o = 0; o < c; ++o) s = null, (n = (i = t.getDatasetMeta(o)).dataset) && n._model && n instanceof Rt.Line && (s = {
                    visible: t.isDatasetVisible(o),
                    fill: Qi(n, o, c),
                    chart: t,
                    el: n
                }), i.$filler = s, h.push(s);
                for (o = 0; o < c; ++o)(s = h[o]) && (s.fill = Gi(h, o, d), s.boundary = Zi(s), s.mapper = (l = void 0, r = (a = s).fill, !(l = "dataset") === r ? null : (isFinite(r) || (l = "boundary"), Xi[l](a))))
            },
            beforeDatasetDraw: function(t, e) {
                ...
                if (i) {
                    ...
                    r && l && a.length && (dt.canvas.clipArea(o, t.chartArea), function(t, e, i, o, n, s) {
                        var a, r, l, c, d, h, u, p = e.length,
                            ...
                            v = 0,
                            b = 0;
                        for (t.beginPath(), a = 0, r = p + !!s; a < r; ++a) d = i(c = e[l = a % p]._view, l, o), h = Ki(c), u = Ki(d), h && u ? (v = g.push(c), b = m.push(d)) : v && b && (f ? (h && g.push(c), u && m.push(d)) : (Ji(t, g, m, v, b), v = b = 0, g = [], m = []));
                        Ji(t, g, m, v, b), t.closePath(), t.fillStyle = n, t.fill()
                    }(o, a, r, s, l, n._loop), dt.canvas.unclipArea(o))
                }
            }
        },
        eo = dt.noop,
    ...
    var no = gt.extend({
        ...
        fit: function() {
            ...
            if (c ? (l.width = t.maxWidth, l.height = i ? 10 : 0) : (l.width = i ? 10 : 0, l.height = t.maxHeight), i)
                if (n.font = s.string, c) {
                    var d = t.lineWidths = [0],
                        h = 0;
                    n.textAlign = "left", n.textBaseline = "top", dt.each(t.legendItems, function(t, e) {
                        var i = oo(o, a) + a / 2 + n.measureText(t.text).width;
                        (0 === e || d[d.length - 1] + i + o.padding > l.width) && (h += a + o.padding, d[d.length - (0 < e ? 0 : 1)] = o.padding), r[e] = {
                            left: 0,
                            top: 0,
                            width: i,
                            height: a
                    ...
                    dt.each(t.legendItems, function(t, e) {
                        var i = oo(o, a) + a / 2 + n.measureText(t.text).width;
                        0 < e && m + v > l.height - u && (f += g + o.padding, p.push(g), m = g = 0), g = Math.max(g, i), m += v, r[e] = {
                            left: 0,
                            top: 0,
                            width: i,
                            height: a
                        }
                    }), f += g, p.push(g), l.width += f
                }
        ...
        draw: function() {
            ...
            if (u.display) {
                var b, y = h.ctx,
                    e = io(p.fontColor, t.defaultFontColor),
                    i = dt.options._parseFont(p),
                    x = i.size;
                ...
                dt.each(h.legendItems, function(t, e) {
                    var i, o, n, s, a, r = y.measureText(t.text).width,
                        l = _ + x / 2 + r,
                        c = b.x,
                        d = b.y;
                    k ? 0 < e && c + l + p.padding > h.left + h.minSize.width && (d = b.y += S, b.line++, c = b.x = h.left + (m - v[b.line]) / 2 + p.padding) : 0 < e && d + S > h.top + h.minSize.height && (c = b.x = c + h.columnWidths[b.line] + p.padding, d = b.y = h.top + p.padding, b.line++),
                        function(t, e, i) {
                            if (!(isNaN(_) || _ <= 0)) {
                                y.save();
                                var o = io(i.lineWidth, g.borderWidth);
                                if (y.fillStyle = io(i.fillStyle, f), y.lineCap = io(i.lineCap, g.borderCapStyle), y.lineDashOffset = io(i.lineDashOffset, g.borderDashOffset), y.lineJoin = io(i.lineJoin, g.borderJoinStyle), y.lineWidth = o, y.strokeStyle = io(i.strokeStyle, f), y.setLineDash && y.setLineDash(io(i.lineDash, g.borderDash)), u.labels && u.labels.usePointStyle) {
                                    var n = _ * Math.SQRT2 / 2,
                                        s = t + _ / 2,
                                        a = e + x / 2;
                                    dt.canvas.drawPoint(y, i.pointStyle, n, s, a)
                                } else 0 !== o && y.strokeRect(t, e, _, x), y.fillRect(t, e, _, x);
                                y.restore()
                            }
                        }(c, d, t), w[e].left = c, w[e].top = d, i = t, o = r, s = _ + (n = x / 2) + c, a = d + n, y.fillText(i.text, s, a), i.hidden && (y.beginPath(), y.lineWidth = 2, y.moveTo(s, a), y.lineTo(s + o, a), y.stroke()), k ? b.x += l + p.padding : b.y += S
                })
            }
        },
    ...
    var ao = {
            ...
            beforeUpdate: function(t) {
                var e = t.options.legend,
                    i = t.legend;
                e ? (dt.mergeIf(e, rt.global.legend), i ? (_e.configure(t, i, e), i.options = e) : so(t, e)) : i && (_e.removeBox(t, i), delete t.legend)
            },
    ...
    var ho = {},
        ...
        fo = {
            ...
            beforeUpdate: function(t) {
                var e = t.options.title,
                    i = t.titleBlock;
                e ? (dt.mergeIf(e, rt.global.title), i ? (_e.configure(t, i, e), i.options = e) : co(t, e)) : i && (_e.removeBox(t, i), delete t.titleBlock)
            }
        };
    for (var go in ho.filler = uo, ho.legend = po, ho.title = fo, (ei.helpers = dt).where = function(t, e) {
            ...
            for (e = 0; e < h; ++e)
                if (!(o = d[e]).model.skip) {
                    if (i = 0 < e ? d[e - 1] : null, (n = e < h - 1 ? d[e + 1] : null) && !n.model.skip) {
            ...
            for (e = 0; e < h - 1; ++e) o = d[e], n = d[e + 1], o.model.skip || n.model.skip || (dt.almostEquals(o.deltaK, 0, this.EPSILON) ? o.mK = n.mK = 0 : (s = o.mK / o.deltaK, a = n.mK / o.deltaK, (l = Math.pow(s, 2) + Math.pow(a, 2)) <= 9 || (r = 3 / Math.sqrt(l), o.mK = s * r * o.deltaK, n.mK = a * r * o.deltaK)));
            for (e = 0; e < h; ++e)(o = d[e]).model.skip || (i = 0 < e ? d[e - 1] : null, n = e < h - 1 ? d[e + 1] : null, i && !i.model.skip && (c = (o.model.x - i.model.x) / 3, o.model.controlPointPreviousX = o.model.x - c, o.model.controlPointPreviousY = o.model.y - c * o.mK), n && !n.model.skip && (c = (n.model.x - o.model.x) / 3, o.model.controlPointNextX = o.model.x + c, o.model.controlPointNextY = o.model.y + c * o.mK))
            ...
            var i, o, n = t.originalEvent || t,
                s = t.target || t.srcElement,
                a = s.getBoundingClientRect(),
                r = n.touches;
            o = r && 0 < r.length ? (i = r[0].clientX, r[0].clientY) : (i = n.clientX, n.clientY);
            ...
            if (1 !== i) {
                var o = t.canvas,
                    n = t.height,
                    s = t.width;
                o.height = n * i, o.width = s * i, t.ctx.scale(i, i), o.style.height || o.style.width || (o.style.height = n + "px", o.style.width = s + "px")
            }
        ...
        }, ei._adapters = ni, ei.Animation = vt, ei.animationService = bt, ei.controllers = ce, ei.DatasetController = kt, ei.defaults = rt, ei.Element = gt, ei.elements = Rt, ei.Interaction = me, ei.layouts = _e, ei.platform = Ee, ei.plugins = Re, ei.Scale = di, ei.scaleService = We, ei.Ticks = si, ei.Tooltip = Qe, ei.helpers.each(Yi, function(t, e) {
            ei.scaleService.registerScaleType(e, t, t._defaults)
        }), ho) ho.hasOwnProperty(go) && ei.plugins.register(ho[go]);
    ...
    var yo = ei;
    return "undefined" != typeof window && (window.Chart = ei), (ei.Chart = ei).Legend = ho.legend._element, ei.Title = ho.title._element, ei.pluginService = ei.plugins, ei.PluginBase = ei.Element.extend({}), ei.canvasHelpers = ei.helpers.canvas, ei.layoutService = ei.layouts, ei.LinearScaleBase = fi, ei.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function(i) {
        ei[i] = function(t, e) {
        ...
        g.extend(o.prototype, {
            ...
            revealContent: function(e) {
                var t, i, o, n, s = this,
                    ...
                    r = !1,
                    l = !1;
                return t = e.opts[s.firstRun ? "animationEffect" : "transitionEffect"], o = e.opts[s.firstRun ? "animationDuration" : "transitionDuration"], o = parseInt(e.forcedDuration === m ? o : e.forcedDuration, 10), e.pos === s.currPos && (e.isComplete ? t = !1 : s.isAnimating = !0), !e.isMoved && e.pos === s.currPos && o || (t = !1), "zoom" === t && (e.pos === s.currPos && o && "image" === e.type && !e.hasError && (l = s.getThumbPos(e)) ? r = s.getFitPos(e) : t = "fade"), "zoom" === t ? (r.scaleX = r.width / l.width, r.scaleY = r.height / l.height, "auto" == (n = e.opts.zoomOpacity) && (n = .1 < Math.abs(e.width / e.height - l.width / l.height)), n && (l.opacity = .1, r.opacity = 1), g.fancybox.setTranslate(e.$content.removeClass("fancybox-is-hidden"), l), f(e.$content), void g.fancybox.animate(e.$content, r, o, function() {
                    s.isAnimating = !1, s.complete()
                })) : (s.updateSlide(e), t ? (g.fancybox.stop(a), i = "fancybox-animated fancybox-slide--" + (e.pos >= s.prevPos ? "next" : "previous") + " fancybox-fx-" + t, a.removeAttr("style").removeClass("fancybox-slide--current fancybox-slide--next fancybox-slide--previous").addClass(i), e.$content.removeClass("fancybox-is-hidden"), f(a), void g.fancybox.animate(a, "fancybox-slide--current", o, function(t) {
                    a.removeClass(i).removeAttr("style"), e.pos === s.currPos && s.complete()
                }, !0)) : (f(a), e.$content.removeClass("fancybox-is-hidden"), void(e.pos === s.currPos && s.complete())))
            },
...
function(p) {
    ...
    p(document).on("objectNeedsType.fb", function(t, e, n) {
        var i, s, a, r, l, c, d, h = n.src || "",
            u = !1;
        i = p.extend(!0, {}, o, n.opts.media), p.each(i, function(t, e) {
...
function(g, r, m) {
    ...
    i.prototype.destroy = function() {
        ...
        var t, e, i, o, n, s, a = this.canvasWidth,
            r = this.canvasHeight,
            l = this.distanceX,
            c = this.distanceY,
            ...
            p = d.width,
            f = d.height;
        return n = a < p ? h + l : h, s = u + c, t = Math.max(0, .5 * a - .5 * p), e = Math.max(0, .5 * r - .5 * f), i = Math.min(a - p, .5 * a - .5 * p), o = Math.min(r - f, .5 * r - .5 * f), 0 < l && t < n && (n = t - 1 + Math.pow(-t + h + l, .8) || 0), l < 0 && n < i && (n = i + 1 - Math.pow(i - h - l, .8) || 0), 0 < c && e < s && (s = e - 1 + Math.pow(-e + u + c, .8) || 0), c < 0 && s < o && (s = o + 1 - Math.pow(o - u - c, .8) || 0), {
            top: s,
            left: n
        }
...
function(t) {
    ...
    function o(t) {
        ...
        if ("image" == (n.clk = e).type)
            ...
            var s = i.offset();
            n.clk_x = t.pageX - s.left, n.clk_y = t.pageY - s.top
        } else n.clk_x = t.pageX - e.offsetLeft, n.clk_y = t.pageY - e.offsetTop;
        setTimeout(function() {
    ...
    F.fn.attr2 = function() {
        ...
        } else P.success && r.push(P.success);
        if (P.success = function(t, e, i) {
                for (var o = P.context || this, n = 0, s = r.length; n < s; n++) r[n].apply(o, [t, e, i || A, A])
            }, P.error) {
            var c = P.error;
                ...
                if (!f.aborted && !k) {
                    ...
                    if (w && w.location.href != d.iframeSrc || g) {
                        ...
                        try {
                            ...
                            } else "xml" == s && !f.responseXML && f.responseText && (f.responseXML = T(f.responseText));
                            try {
                                _ = $(f, s, d)
                            } catch (t) {
        ...
        var o, n, s, a, r, l, c, d, h = this[0],
            u = this.attr("id"),
            p = t ? h.getElementsByTagName("*") : h.elements;
        if (p && !/MSIE [678]/.test(navigator.userAgent) && (p = F(p).get()), u && (o = F(':input[form="' + u + '"]').get()).length && (p = (p || []).concat(o)), !p || !p.length) return i;
        for (n = 0, c = p.length; n < c; n++)
            if ((a = (l = p[n]).name) && !l.disabled)
                if (t && h.clk && "image" == l.type) h.clk == l && (i.push({
                    name: a,
                    value: F(l).val(),
                    type: l.type
                }), i.push({
            ...
            for (e && e.push(l), s = 0, d = r.length; s < d; s++) i.push({
                name: a,
                value: r[s]
            });
    ...
    function y(t) {
        if (function() {
                if (!k) {
                    ...
                    e.appendChild(t);
                    var i = b(t);
                    x = 200 == Math.round(v(i.width)), y.isBoxSizeOuter = x, e.removeChild(t)
                }
...
function(a, r) {
    ...
    l._create = function() {
        ...
        for (var i = [], o = [], n = [], s = this._getFilterTest(e), a = 0; a < t.length; a++) {
            ...
            if (!r.isIgnored) {
                var l = s(r);
                l && i.push(r), l && r.isHidden ? o.push(r) : l || r.isHidden || n.push(r)
            }
        }
        return {
            matches: i,
...
var objectFitImages = function() {
    ...
    function r(e) {
        ...
        if (!n.img) {
            n.img = new Image(e.width, e.height), n.img.srcset = f.call(e, "data-ofi-srcset") || e.srcset, n.img.src = f.call(e, "data-ofi-src") || e.src, g.call(e, "data-ofi-src", e.src), e.srcset && g.call(e, "data-ofi-srcset", e.srcset), s(e, e.naturalWidth || e.width, e.naturalHeight || e.height), e.srcset && (e.srcset = "");
            try {
                i = e, o = {
                    get: function(t) {
                    ...
                    set: function(t, e) {
                        return i[l].img[e || "src"] = t, g.call(i, "data-ofi-" + e, t), r(i), t
                    }
        ...
        })(n.img), e.style.backgroundImage = 'url("' + (n.img.currentSrc || n.img.src).replace(/"/g, '\\"') + '")', e.style.backgroundPosition = t["object-position"] || "center", e.style.backgroundRepeat = "no-repeat", e.style.backgroundOrigin = "content-box", /scale-down/.test(t["object-fit"]) ? a(n.img, function() {
    ...
    function n(t, e) {
        var i = !m && !t;
        if (e = e || {}, t = t || "img", h && !e.skipTest || !u) return !1;
    ...
    var l = "fregante:object-fit-images",
        ...
        g = t.setAttribute,
        m = !1;
    return n.supportsObjectFit = d, (n.supportsObjectPosition = h) || (HTMLImageElement.prototype.getAttribute = function(t) {
...
! function(e) {
    ...
    function s(t, e, i) {
        ...
        for (s in o = {
                ...
                onFinish: null,
                onUpdate: null
            }, "INPUT" !== a[0].nodeName && console && console.warn && console.warn("Base element should be <input>!", a[0]), (n = {
                skin: a.data("skin"),
                type: a.data("type"),
                min: a.data("min"),
                max: a.data("max"),
        ...
        r !== h && "" !== r && ((r = r.split(n.input_values_separator || e.input_values_separator || ";"))[0] && r[0] == +r[0] && (r[0] = +r[0]), r[1] && r[1] == +r[1] && (r[1] = +r[1]), e && e.values && e.values.length ? (o.from = r[0] && e.values.indexOf(r[0]), o.to = r[1] && e.values.indexOf(r[1])) : (o.from = r[0] && +r[0], o.to = r[1] && +r[1])), l.extend(o, e), l.extend(o, n), this.options = o, this.update_check = {}, this.validate(), this.result = {
    ...
    s.prototype = {
            ...
            drawLabels: function() {
                if (this.options) {
                    ...
                    if (!this.options.hide_from_to)
                        if ("single" === this.options.type) t = s ? this.decorate(a[this.result.from]) : (o = this._prettify(this.result.from), this.decorate(o, this.result.from)), this.$cache.single.html(t), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible";
                        else {
                            i = s ? (this.options.decorate_both ? (t = this.decorate(a[this.result.from]), t += this.options.values_separator, t += this.decorate(a[this.result.to])) : t = this.decorate(a[this.result.from] + this.options.values_separator + a[this.result.to]), e = this.decorate(a[this.result.from]), this.decorate(a[this.result.to])) : (o = this._prettify(this.result.from), n = this._prettify(this.result.to), this.options.decorate_both ? (t = this.decorate(o, this.result.from), t += this.options.values_separator, t += this.decorate(n, this.result.to)) : t = this.decorate(o + this.options.values_separator + n, this.result.to), e = this.decorate(o, this.result.from), this.decorate(n, this.result.to)), this.$cache.single.html(t), this.$cache.from.html(e), this.$cache.to.html(i), this.calcLabels();
            ...
            calcGridCollision: function(t, e, i) {
                ...
                for (o = 0; o < a && !(a <= (n = o + t / 2)); o += t) s = this.$cache.grid_labels[n][0], i[o] <= e[n] ? s.style.visibility = "visible" : s.style.visibility = "hidden"
            },
...
function(k, S, c) {
    var i, C, o, n, a, s, r, l, d, h, t, u, e = "mPageScroll2id",
        T = "mPS2id",
        p = {
            scrollSpeed: 1e3,
            autoScrollSpeed: !0,
        ...
        g = {
            init: function(t) {
                t = k.extend(!0, {}, p, t);
                if (k(c).data(T, t), C = k(c).data(T), !this.selector) {
                    var e = "__" + T;
                    this.each(function() {
                        var t = k(this);
                ...
                C.liveSelector && (this.selector += "," + C.liveSelector), i = i ? i + "," + this.selector : this.selector, C.defaultSelector && ("object" == typeof k(i) && 0 !== k(i).length || (i = ".m_PageScroll2id,a[rel~='m_PageScroll2id'],.page-scroll-to-id,a[rel~='page-scroll-to-id'],._ps2id")), C.clickEvents && k(c).undelegate("." + T).delegate(i, "click." + T, function(t) {
                    if (m._isDisabled.call(null)) m._removeClasses.call(null);
                    else {
                        var e = k(this),
                            i = e.attr("href"),
                            o = e.prop("href").baseVal || e.prop("href");
                        C.excludeSelectors && e.is(C.excludeSelectors) || i && -1 !== i.indexOf("#/") || (m._reset.call(null), h = e.data("ps2id-offset") || 0, m._isValid.call(null, i, o) && m._findTarget.call(null, i) && (t.preventDefault(), n = "selector", a = e, m._setClasses.call(null, !0), m._scrollTo.call(null)))
                    }
            ...
            scrollTo: function(t, e) {
                if (m._isDisabled.call(null)) m._removeClasses.call(null);
                    ...
                    e = k.extend(!0, {}, i, e);
                    m._reset.call(null), l = e.layout, d = e.offset, t = -1 !== t.indexOf("#") ? t : "#" + t, m._isValid.call(null, t) && m._findTarget.call(null, t) && (n = "scrollTo", (a = e.clicked) && m._setClasses.call(null, !0), m._scrollTo.call(null))
                }
            },
            destroy: function() {
                k(S).unbind("." + T), k(c).undelegate("." + T).removeData(T), k("._mPS2id-t").removeData(T), m._removeClasses.call(null, !0)
            }
        },
        m = {
            _isDisabled: function() {
                ...
                return "innerWidth" in S || (e = "client", t = c.documentElement || c.body), t[e + "Width"] <= i[0] || t[e + "Height"] <= i[1]
            },
                    ...
                    if (m._isValid.call(null, e, i)) {
                        ...
                        if (0 < n.length) {
                            C.highlightByNextTarget && n !== l && (l ? l.data(T, {
                                ...
                                tn: "0"
                            }), l = n), n.hasClass("_mPS2id-t") || n.addClass("_mPS2id-t"), n.data(T, {
                                i: r
                            }), t.hasClass("_mPS2id-h") || t.addClass("_mPS2id-h");
                            var s = m._findHighlight.call(null, o);
                            m._setClasses.call(null, !1, n, s), f = r, ++r == k(a).length && m._extendClasses.call(null)
                        }
                    }
                })
            },
            ...
            _findTarget: function(t) {
                ...
                return s = i, l = l || C.layout, d = m._setOffset.call(null), (r = [(i.offset().top - d[0]).toString(), (i.offset().left - d[1]).toString()])[0] = r[0] < 0 ? 0 : r[0], r[1] = r[1] < 0 ? 0 : r[1], r
            },
            _setOffset: function() {
                var t, e, i, o;
                switch (d = d || (C.offset ? C.offset : 0), h && (d = h), typeof d) {
                    case "object":
                    case "string":
            ...
            _findHighlight: function(t) {
                var e = S.location,
                    ...
                    o = e.pathname;
                return -1 !== i.indexOf("'") && (i = i.replace("'", "\\'")), -1 !== o.indexOf("'") && (o = o.replace("'", "\\'")), i = decodeURIComponent(i), o = decodeURIComponent(o), k("._mPS2id-h[href='#" + t + "'],._" + T + "-h[href='" + i + "#" + t + "'],._" + T + "-h[href='" + o + "#" + t + "'],._" + T + "-h[href='#/" + t + "'],._" + T + "-h[href='" + i + "#/" + t + "'],._" + T + "-h[href='" + o + "#/" + t + "']")
            },
            _setClasses: function(t, e, i) {
                var o = C.clickedClass,
                    n = C.targetClass,
                    s = C.highlightClass;
                t && o && "" !== o ? (k("." + o).removeClass(o), a.addClass(o)) : e && n && "" !== n && i && s && "" !== s && (m._currentTarget.call(null, e) ? (e.addClass(n), i.addClass(s)) : (!C.keepHighlightUntilNext || 1 < k("." + s).length) && (e.removeClass(n), i.removeClass(s)))
            },
            _extendClasses: function() {
                var t = C.targetClass,
                    ...
                    a = e + "-first",
                    r = e + "-last";
                k("._mPS2id-t").removeClass(n + " " + s), k("._mPS2id-h").removeClass(a + " " + r), C.forceSingleHighlight ? C.keepHighlightUntilNext && 1 < i.length ? (i.slice(0, 1).removeClass(t), o.slice(0, 1).removeClass(e)) : (i.slice(1).removeClass(t), o.slice(1).removeClass(e)) : (i.slice(0, 1).addClass(n).end().slice(-1).addClass(s), o.slice(0, 1).addClass(a).end().slice(-1).addClass(r))
            },
            _removeClasses: function(t) {
                k("." + C.clickedClass).removeClass(C.clickedClass), k("." + C.targetClass).removeClass(C.targetClass + " " + C.targetClass + "-first " + C.targetClass + "-last"), k("." + C.highlightClass).removeClass(C.highlightClass + " " + C.highlightClass + "-first " + C.highlightClass + "-last"), t && (k("._mPS2id-t").removeClass("_mPS2id-t"), k("._mPS2id-h").removeClass("_mPS2id-h"))
            },
            ...
            _scrollTo: function() {
                u = m._scrollSpeed.call(null), r = C.pageEndSmoothScroll ? m._pageEndSmoothScroll.call(null) : r;
                var t = k("html,body"),
                ...
                switch (l) {
                    case "horizontal":
                        n != r[1] && (m._callbacks.call(null, "onStart"), t.stop().animate({
                            scrollLeft: r[1]
                    ...
                    case "auto":
                        ...
                        break;
                    default:
                        o != r[0] && (m._callbacks.call(null, "onStart"), t.stop().animate({
                            scrollTop: r[0]
                        }, e, i).promise().then(function() {
                            m._callbacks.call(null, "onComplete")
                        }))
            ...
            _live: function() {
                t = setTimeout(function() {
                    C.live ? k(m._highlightSelector()).length !== f && m._setup.call(null) : t && clearTimeout(t), m._live.call(null)
                }, 1e3)
            },
            _easing: function() {
                function e(t) {
                ...
                k.easing.easeInQuad = k.easing.easeInQuad || function(t) {
                    ...
                    return 1 - e(1 - t)
                }, k.easing.easeOutBounce = k.easing.easeOutBounce || e, k.easing.easeInOutBounce = k.easing.easeInOutBounce || function(t) {
                    return t < .5 ? (1 - e(1 - 2 * t)) / 2 : (1 + e(2 * t - 1)) / 2
                }
            }
        };
    m._easing.call(), k.fn[e] = function(t) {
    ...
    o.prototype.init = function() {
        ...
        return this.$element.addClass(r.options.classes.container), t.addClass(r.options.classes.ul), d("li", t).each(function() {
            ...
            if (!s.hasClass(r.options.classes.stateExcluded)) {
                n = (t = d("a", s)).attr("href"), e = d(n), i = d(r.options.accordionTabElement).insertBefore(e), o = d("<a></a>").attr("href", n).html(t.html()).appendTo(i);
                var a = {
                    _ignoreHashChange: !1,
                    id: c,
    ...
    e = this, i = function(l, s) {
        ...
        function y(t, e, i) {
            ...
            "bottom-in-view" === (i = l.extend({}, l.fn[v].defaults, i)).offset && (i.offset = function() {
                var t;
                return t = l[b]("viewportHeight"), l.isWindow(e.element) || (t = e.$element.height()), t - l(this).outerHeight()
        ...
        return e = l(s), n = 0 <= x.call(s, "ontouchstart"), c = {
            ...
            }, !n || t.vertical.oldScroll && t.vertical.newScroll || l[b]("refresh"), l.each(t, function(t, n) {
                var i, e, s;
                return s = [], e = n.newScroll > n.oldScroll, i = e ? n.forward : n.backward, l.each(o.waypoints[t], function(t, e) {
                    var i, o;
            ...
            init: function(t, n) {
                return null == n && (n = {}), null == n.handler && (n.handler = t), this.each(function() {
                    var t, e, i, o;
                    return t = l(this), i = null != (o = n.context) ? o : l.fn[v].defaults.context, l.isWindow(i) || (i = t.closest(i)), i = l(i), e = (e = h[i.data(d)]) || new a(i), new r(t, e, n)
                }), l[b]("refresh"), this
            },
            disable: function() {
            ...
            _invoke: function(t, i) {
                return t.each(function() {
                    var t;
                    return t = r.getWaypointsByElement(this), l.each(t, function(t, e) {
                        return e[i](), !0
                    })
                }), this
            }
            ...
            var t, e;
            return e = arguments[0], t = 2 <= arguments.length ? _.call(arguments, 1) : [], o[e] ? o[e].apply(this, t) : l.isFunction(e) ? o.init.apply(this, arguments) : l.isPlainObject(e) ? o.init.apply(this, [null, e]) : e ? l.error("The " + e + " method does not exist in jQuery Waypoints.") : l.error("jQuery Waypoints needs a callback function or handler option.")
        }, l.fn[v].defaults = {
            context: s,
            continuous: !0,
            enabled: !0,
            ...
            aggregate: function(t) {
                var e, o, i;
                return e = c, t && (e = null != (i = h[l(t).data(d)]) ? i.waypoints : void 0), e ? (o = {
                    horizontal: [],
                    vertical: []
            ...
            _filter: function(t, e, i) {
                var o, n;
                return (o = h[l(t).data(d)]) ? (n = [], l.each(o.waypoints[e], function(t, e) {
            ...
            var t, e;
            return e = arguments[0], t = 2 <= arguments.length ? _.call(arguments, 1) : [], u[e] ? u[e].apply(null, t) : u.aggregate.call(null, e)
        }, l[b].settings = {
            resizeThrottle: 100,
            scrollThrottle: 30
        }, e.load(function() {
